...
<script type="text/javascript" src="../js/moveex/moveex211.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size="3" color="#ff0000"><b>お手本</b></font><br /><br>　色々な種類の変数を宣言してみよう。</p>
...
<div id="ver" version="e211" type="ex"></div>
<div id="state" type = "hidden">2</div>
<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第一節　変数の宣言・代入　>　お手本１">
  		<p><br />
    	<b>色々な種類の変数を宣言してみよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイアログここまで   -->
