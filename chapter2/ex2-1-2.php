...
<script type="text/javascript" src="../js/moveex/moveex212.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size="4" color="#ff0000"><b>お手本</b></font><br /><br />　変数xに5を代入し<br />　変数yにxを代入しよう。</p>
...
準備ができたらお手本開始ボタンを押すにゃ</b></p>
			...
			<input type="image" src ="../img/ex_button001.png" value="サンプル実行" id="button" style = "width:123px;height:56px;position:absolute; bottom:0px; right:0px;margin:0px;" onclick = "tabplay()">
		</div>
	</div>
	
	<div class = "console-box">
			▼コンソール<br>
	<textarea class = "console" style="resize: none; overflow:auto;"id="console" name="code" rows="5" cols="50" onkeydown="if(event.keyCode === 13){newscanfnext();}"/></textarea>
	</div>
</div>
<div id="ver" version="e212" type="ex"></div>
<div id="state" type = "hidden">4</div>
<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第一節　変数の宣言・代入　>　お手本２">
  		<p><br />
    	<b>変数xに5を代入し、変数yにxを代入しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイアログここまで   -->
