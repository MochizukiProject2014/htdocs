...
<script type="text/javascript" src="../js/moveex/moveex221.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size="4" color="#ff0000"><b>お手本</b></font><br /><br />　変数に値を入力しよう。</p>
		</br><br />
   ...
   return 0;
	...
	<div class = "anime-box">
		...
		<ul class = "content">
			...
			<li class = "hide"><div class = "dic"><object data="../dic/dic3.html" type="text/html" width="730" height="460"></object></div></li>
...
準備ができたらお手本開始ボタンを押すにゃ</b></p>
	...
	<div id = "introduction" value="<b>おまじないだにゃ<b/>@@<b>今回はコンソールに入力した値をxに代入する方法を教えるにゃ@@<b>xを宣言してるにゃ@@<b>コンソールに入力した値をxに代入してるにゃ<br/>scanfを実行するときは、コンソールに代入したい数字を直接入力するにゃ、そのあとenterキーを押せばscanfが実行されるにゃ。</b>@@<b>おまじないだにゃ@@<b>お手本はこれで終わりだにゃ！<br />右上のボタンから問題に挑戦してみるにゃ！！"></div>
</div>
<div id="ver" version="e221" type="ex"></div>
<div id="state" type = "hidden">8</div>
<!--　ダイアログ　-->
