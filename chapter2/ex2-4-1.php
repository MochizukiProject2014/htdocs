...
<script type="text/javascript" src="../js/moveex/moveex241.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size="4" color="#ff0000"><b>お手本</b></font><br /><br />　int型の変数xに3を代入し、<br>　「xは3です」とprintfで出力しよう。</p>
   ...
   return 0;
	...
	<div class = "anime-box">
		...
		<ul class = "content">
			...
			<li class = "hide"><div class = "dic"><object data="../dic/dic5.html" type="text/html" width="730" height="460"></object></div></li>
...
準備ができたらお手本開始ボタンを押すにゃ</b></p>
	...
	<div id = "introduction" value="&nbsp;@@&nbsp;@@&nbsp;@@&nbsp;@@<b>printfでxを出力しているにゃ、<br/>%dの部分にxの中身が出力されるにゃ@@&nbsp;@@<b>お手本はこれで終わりだにゃ！<br />右上のボタンから問題に挑戦してみるにゃ！！</b>"></div>
</div>
<div id="ver" version="e241" type="ex"></div>
<div id="state" type = "hidden">14</div>
<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第四節　printf　>　お手本１">
  		<p><br />
    	<b>int型の変数xに3を代入し、「xは3です」とprintfで出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイアログここまで   -->
