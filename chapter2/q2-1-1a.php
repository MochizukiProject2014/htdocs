...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br>　char型の変数zを宣言しよう<br /></font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_1_1a();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_1_1a_1()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2111"></div>
	<div id="state">-2111</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第一節　変数の宣言・代入　>　問題１a">
  		<p><br />
    	<b>char型の変数zを宣言しよう。
		</b><br />
 		</p>
