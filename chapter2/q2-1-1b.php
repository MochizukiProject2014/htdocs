...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br>int型の変数x,yを同時に宣言しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_1_1b();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_1_1b_1()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2112"></div>
	<div id="state">-2112</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第一節　変数の宣言・代入　>　問題１">
  		<p><br />
    	<b>int型の変数x,yを同時に宣言しよう
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
