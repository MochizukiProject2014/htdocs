...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_1_2_1()"></td>
    			<td><input type="button" value="２" onClick="hintq2_1_2_2()"></td>
       		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="212"></div>
	<div id="state">5</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第一節　変数の宣言・代入　>　問題２">
  		<p><br />
    	<b>int型のxを宣言してから、10を代入してみよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
