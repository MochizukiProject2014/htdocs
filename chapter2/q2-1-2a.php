...
?></div>
    	...
    	<a href="../img/screen_img/mondai-01.jpg" data-lightbox="group2" class = "screen" id = "click_data"><img src='../img/new_button/b005.png' alt="画面説明" onMouseOver=this.src='../img/new_button/b005-2.png' onMouseOut=this.src='../img/new_button/b005.png'></a>
...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br>double型の変数yを宣言してから、<br />　変数yに3.2を代入してみよう。</font></p>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_1_2a_1()"></td>
       		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2121"></div>
	<div id="state">-2121</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第一節　変数の宣言・代入　>　問題２">
  		<p><br />
    	<b>double型の変数yを宣言してから、変数yに3,2を代入してみよう<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
