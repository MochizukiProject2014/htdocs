...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br>char型の変数aを宣言してから、<br />　変数aに「s」を代入してみよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_1_2b()"></br>
...
int main(void){
   ...
   return 0;
		...
		<input type="button" value="実行" id="button" onclick = "tabplay()"></input>
	</div>
	...
	<div class = "anime-box">
		...
		<ul class = "content">
			...
			<li class = "hide"><div class = "dic"><object data="../dic/dic2.html" type="text/html" width="730" height="460"></object></div></li>
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_1_2b_1()"></td>
       		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2122"></div>
	<div id="state">-2122</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第一節　変数の宣言・代入　>　問題２">
  		<p><br />
    	<b>char型の変数aを宣言してから、変数aに「s」を代入してみよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
