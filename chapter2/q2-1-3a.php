...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br />　char型の変数xを「y」で初期化しよう</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_1_3a();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_1_3a()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2131"></div>
	<div id="state">-2131</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第一節　変数の宣言・代入　>　問題3">
  		<p><br />
    	<b>char型の変数xを「y」で初期化しよう<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
