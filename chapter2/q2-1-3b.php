...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br />　int型の変数xとyを同時に初期化しよう。<br/>（それぞれxは3、yは7で初期化しよう）</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_1_3b();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_1_3b()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2132"></div>
	<div id="state">-2132</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第一節　変数の宣言・代入　>　問題3">
  		<p><br />
    	<b>int型の変数xとyを同時に初期化しよう。（それぞれxは3、yは7で初期化しよう）<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
