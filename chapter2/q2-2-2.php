...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />　変数xに15、変数yに5.5をキーボードから入力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_2_2();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div id="ver" version="222"></div>
	<div id="state" type = "hideen">10</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第二節　scanf　>　問題２">
  		<p><br />
    	<b>xに15、yに5.5をキーボードから入力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
