...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />変数xに「k」をキーボードから代入しよう</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_2_2a();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_2_2a_1()"></td>
    			<td><input type="button" value="２" onClick="hintq2_2_2a_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2221"></div>
	<div id="state">-2221</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第二節　scanf　>　問題２">
  		<p><br />
    	<b>変数xに「k」をキーボードから代入しよう<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
