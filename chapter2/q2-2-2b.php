...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />　変数xに「n」、変数yに3.6をscanf文を一つだけ使ってキーボードから代入しよう</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_2_2b();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_2_2b_1()"></td>
    			<td><input type="button" value="２" onClick="hintq2_2_2b_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2222"></div>
	<div id="state">-2222</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第二節　scanf　>　問題２">
  		<p><br />
    	<b>変数xに「n」、変数yに3.6をscanf文を一つだけ使ってキーボードから代入しよう<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
