...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />int型のxにキーボードから値を代入し、</br>その後xにxをかけた値をxに代入しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_3_1a();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_3_1a_1()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2311"></div>
	<div id="state">-2311</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第三節　数式　>　問題１">
  		<p><br />
    	<b>int型のxにキーボードから値を代入し、その後xにxをかけた値をxに代入しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
