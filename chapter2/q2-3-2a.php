...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br>　int型の変数xにキーボードから「10」を入力し、<br />その後変数xを3で割った余りをint型の変数yに代入しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_3_2a();"></br>
   ...
   return 0;
	...
	<div class = "anime-box">
		...
		<ul class = "content">
			...
			<li class = "hide"><div class = "dic"><object data="../dic/dic4.html" type="text/html" width="730" height="460"></object></div></li>
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_3_2a_1()"></td>
    			<td><input type="button" value="２" onClick="hintq2_3_2a_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2321"></div>
	<div id="state">-2321</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第三節　数式　>　問題２">
  		<p><br />
    	<b>int型の変数xにキーボードから「10」を入力し、その後変数xを3で割った余りをint型の変数yに代入しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
