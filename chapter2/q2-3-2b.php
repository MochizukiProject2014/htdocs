...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br>int型の変数xにキーボードから「10」を代入し、<br />その後yにxから3.5を引いた値を代入しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_3_2b();"></br>
...
　　　
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_3_2b()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2322"></div>
	<div id="state">-2322</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第三節　数式　>　問題２">
  		<p><br />
    	<b>int型の変数xにキーボードから「10」を代入し、その後yにxから3.5を引いた値を代入しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
