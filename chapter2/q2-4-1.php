...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />　int型の変数に値をscanfで入力し、<br>　入力された変数をprintfで出力しよう。</font></p>
...
int main(void){
   ...
   return 0;
	...
	<div id="ver" version="241"></div>
	<div id="state">15</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第四節　printf　>　問題１">
  		<p><br />
    	<b>int型の変数に値をscanfで入力し、入力された変数をprintfで出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
