...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />　char型で変数xを宣言し、<br>　scanfでxに「a」を代入しprintfでxを出力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_4_1b();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_4_1b()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2412"></div>
	<div id="state">-2412</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第四節　printf　>　問題１">
  		<p><br />
    	<b>char型で変数xを宣言し、scanfでxに「a」を代入しprintfでxを出力しよう<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
