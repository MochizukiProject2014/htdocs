...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_4_2_1()"></td>
    			<td><input type="button" value="２" onClick="hintq2_4_2_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="242"></div>
	<div id="state">16</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第四節　printf　>　問題２">
  		<p><br />
    	<b>double型でxを、char型でyを宣言して、xとyをprintfで出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
