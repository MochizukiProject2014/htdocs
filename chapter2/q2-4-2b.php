...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />int型で変数x,yを宣言し、xに1、yに3を代入し、<br />一つのprintfでxを出力し、改行してyを出力しよう</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq2_4_2b();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq2_4_2b_1()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="2422"></div>
	<div id="state">-2422</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第二章　変数　>　第四節　printf　>　問題２">
  		<p><br />
    	<b>int型で変数x,yを宣言し、xに1、yに3を代入し、一つのprintfでxを出力し、改行してyを出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
