...
<script type="text/javascript" src="../js/moveex/moveex311.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size="4" color="#ff0000"><b>お手本</b></font><br /><br />　もしxが5以下なら「xは５より小さいです」と<br>　出力しよう。</p>
...
<div id="ver" version="e311" type="ex"></div>
<div id="state" type = "hideen">18</div>

<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第一節　if　>　お手本１">
  		<p><br />
    	<b>もしxが5以下なら「xは５より小さいです」と出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイアログここまで   -->
