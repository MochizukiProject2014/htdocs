...
<script type="text/javascript" src="../js/moveex/moveex312.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size="4" color="#ff0000"><b>お手本</b></font><br /><br />　入力された値が『-５以上５未満』のとき<br />　正解と表示させよう.</p>
...
<div id="ver" version="e312" type="ex"></div>
<div id="state">22</div>
<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第一節　if　>　お手本２">
  		<p><br />
    	<b>入力された値が『-５以上５未満』のとき正解と表示させよう.<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイアログここまで   -->
