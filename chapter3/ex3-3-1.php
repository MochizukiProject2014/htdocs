...
<script type="text/javascript" src="../js/moveex/moveex331.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size="4" color="#ff0000"><b>お手本</b></font><br /><br />　xにscanfで入力し、xを3で割った余りを<br>　出力するプログラムにしよう。</p>
...
int main(void){
   ...
   scanf("%d",&x);
   if(x%3 == 0){
       printf("xを3で割った余りは０です");
   }else if(x%3 == 1){
       printf("xを3で割った余りは1です");
   }else{
       printf("xを3で割った余りは2です");
   }
   return 0;
}</textarea>
	</div>
...
<div id="ver" version="e331" type="ex"></div>
<div id="state">26</div>
<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第三節　else if　>　お手本１">
  		<p><br />
    	<b>xにscanfで入力し、xを3で割った余りを出力するプログラムにしよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイアログここまで   -->
