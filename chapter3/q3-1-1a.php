...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br>　もしxが15より小さいなら「xは15より<br>　小さいです」と出力するプログラムにしよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq3_1_1a();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_1_1a_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_1_1a_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="3111"></div>
	<div id="state">-3111</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第一節　if　>　問題１">
  		<p><br />
    	<b>もしxが15より小さいなら「xは15より小さいです」と出力するプログラムにしよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
