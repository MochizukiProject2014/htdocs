...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br>　もしxが30以上なら「xは30以上<br>　です」と出力するプログラムにしよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq3_1_1b();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_1_1b_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_1_1b_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="3112"></div>
	<div id="state">-3112</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第一節　if　>　問題１">
  		<p><br />
    	<b>もしxが30以上なら「xは30以上です」と出力するプログラムにしよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
