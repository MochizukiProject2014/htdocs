...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br>　もしxがyより大きいなら<br />　「xはyより大きいです」と出力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq3_1_2a();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_1_2a_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_1_2a_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="3121"></div>
	<div id="state">-3121</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第一節　if　>　問題２">
  		<p><br />
    	<b>もしxがyより大きいなら「xはyより大きいです」と出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
