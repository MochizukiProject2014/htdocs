...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
		...
		<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />　bmi数値を計算して、bmiが18.5以上25.0未満<br />　なら「あなたは適正です」と出力しよう。<br/><br/>
		（条件式に && を使ってみよう。）</font></p>
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_1_4_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_1_4_2()"></td>
    			<td><input type="button" value="３" onClick="hintq3_1_4_3()"></td>
    		</tr>
    	</table>
	</div>
