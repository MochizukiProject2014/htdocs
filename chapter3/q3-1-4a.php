...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
		...
		<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />　xの身長が150cmであり、yの身長が165cmである<br />　なら「xは150cm・yは165cmです」と出力しよう。<br/><br/>
		（条件式に && を使ってみよう。）</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq3_1_4a();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_1_4a_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_1_4a_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="3141"></div>
	<div id="state">-3141</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第一節　if　>　問題４">
  		<p><br />
    	<b>xの身長が150cmであり、yの身長が165cmであるなら「xは150cm・yは165cmです」と出力しよう。<br/>
    	（条件式に && を使ってみよう。）
		</b><br />
 		</p>
	</div>
