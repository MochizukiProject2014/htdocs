...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />　scanfで年齢を入力して、もし2人とも成人なら「xもyも成人です。」、<br />　どちらか片方でも未成年なら「少なくとも片方は未成年です。」と出力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq3_2_1a();"></br>
...
int main(void){ 
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_2_1a_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_2_1a_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="3211"></div>
	<div id="state">-3211</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第二節　else　>　問題１">
  		<p><br />
    	<b>scanfで年齢を入力して、もし2人とも成人なら「xもyも成人です。」、どちらか片方でも未成年なら「少なくとも片方は未成年です。」と出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
