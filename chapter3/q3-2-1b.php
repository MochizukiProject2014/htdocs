...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "3">問題<br /><br />　scanfで年齢を入力して、どちらか片方でも成人なら「少なくともどちらか片方は成人です。」、<br />　両方が未成年なら「xもyも未成年です。」と出力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq3_2_1b();"></br>
...
int main(void){ 
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_2_1b_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_2_1b_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="3212"></div>
	<div id="state">-3212</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第二節　else　>　問題１">
  		<p><br />
    	<b>scanfで年齢を入力して、どちらか片方でも成人なら「少なくともどちらか片方は成人です。」、両方が未成年なら「xもyも未成年です。」と出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
