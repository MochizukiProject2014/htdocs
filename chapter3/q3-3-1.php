...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
   	...
   	<div class = "code-box">
		<p class = "question"><font size = "2">問題<br />　int型の変数scoreに成績をscanfで入力し、<br />　90点以上なら「良」、60点以上90点未満なら「可」、<br />　40点以上60点未満なら「再試験」、<br />　それ以外なら「不可」と出力しよう。</font></p>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_3_1_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_3_1_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="331"></div>
	<div id="state">27</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第三節　else if　>　問題１">
  		<p><br />
    	<b>int型の変数scoreに成績をscanfで入力し、90点以上なら「良」、<br>60点以上90点未満なら「可」、<br>40点以上60点未満なら「再試験」、それ以外なら「不可」と出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
