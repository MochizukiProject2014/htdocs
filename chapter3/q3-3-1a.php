...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
   	...
   	<div class = "code-box">
		<p class = "question"><font size = "2">問題<br />　100点満点のテストの点数をint型の変数scoreに入力し、<br />　0点以上60点未満なら「不合格」、それ以外なら<br />　「その点数はありえません。」と出力するプログラムを作ろう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq3_3_1a();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_3_1a_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_3_1a_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="3311"></div>
	<div id="state">-3311</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第三節　else if　>　問題１">
  		<p><br />
    	<b>100点満点のテストの点数をint型の変数scoreに入力し、60点以上100点以下なら「合格」、0点以上60点未満なら「不合格」、それ以外なら「その点数はありえません。」と出力するプログラムを作ろう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
