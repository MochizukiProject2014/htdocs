...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
   	...
   	<div class = "code-box">
		<p class = "question"><font size = "2">問題<br />　男性の靴のサイズをdouble型の変数sizeに入力し、23.5以上24.5未満なら<br />　「Sサイズです。」、24.5点以上25.5未満なら「Mサイズ」、<br />　25.5点以上26.5以下なら「Lサイズ」、それ以外なら「そのサイズは<br />　お取り扱いしておりません。」と出力するプログラムを作ろう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq3_3_1b();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq3_3_1b_1()"></td>
    			<td><input type="button" value="２" onClick="hintq3_3_1b_2()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="3312"></div>
	<div id="state">-3312</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第三章　条件分岐　>　第三節　else if　>　問題１">
  		<p><br />
    	<b>男性の靴のサイズをdouble型の変数sizeに入力し、23.5以上24.5未満なら「Sサイズです。」、24.5点以上25.5未満なら「Mサイズ」、25.5点以上26.5以下なら「Lサイズ」、それ以外なら「そのサイズはお取り扱いしておりません。」と出力するプログラムを作ろう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
