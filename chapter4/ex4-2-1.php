...
<script type="text/javascript" src="../js/moveex/moveex421.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		...
		<b>お手本</b></font><br><br />　while文を使って、0を入力するまで数字を<br />　入力し続けるプログラムを作ろう。</p>
...
<div id="ver" version="e421" type="ex"></div>
<div id="state">32</div>
<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章 繰り返し　>　第二節 while　>　お手本１">
  		<p><br />
    	<b>while文を使って、0を入力するまで数字を入力し続けるプログラムを作ろう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイアログここまで   -->
