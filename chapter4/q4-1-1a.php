...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br />　「for文を使って「わんわん」と出力を<br>　3回繰り返し、現在何回繰り返したかを<br>　「現在○回繰り返しました」のように<br>　表示するプログラムを作ろう</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq4_1_1a();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq4_1_1a_1();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="4111"></div>
	<div id="state">-4111</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章　繰り返し　>　第一節　for　>　追加問題１">
  		<p><br />
    	<b>for文を使って「わんわん」を出力を3回繰り返し、<br />現在何回繰り返したかを「現在○回繰り返しました」のように<br />表示するプログラムを作ろう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
