...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br>　for文を使って1～10の間の<br />偶数を表示するプログラムを作ろう</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq4_1_1b();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq4_1_1b_1();"></td>
    			<td><input type="button" value="２" onClick="hintq4_1_1b_2();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="4112"></div>
	<div id="state">-4112</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章　繰り返し　>　第一節　for　>　追加問題２">
  		<p><br />
    	<b>for文を使って1～10の間の偶数を表示するプログラムを作ろう
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
