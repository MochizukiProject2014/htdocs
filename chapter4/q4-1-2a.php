...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br />　for文を使って「にゃんにゃん」を3回<br />　出力したあと何回繰り返すかを<br />　「あと○回繰り返します」のように<br />　表示するプログラムを作ろう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq4_1_2a();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq4_1_2a();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="4121"></div>
	<div id="state">-4121</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章　繰り返し　>　第一節　for　>　問題２">
  		<p><br />
    	<b>for文を使って「にゃんにゃん」を3回出力したあと<br />何回繰り返すかを「あと○回繰り返します」のように<br />表示するプログラムを作ろう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
