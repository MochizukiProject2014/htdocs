...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br>　for文を使って値を4回入力し、<br />　4回入力した値の平均値を求め<br>　「平均値は○です」と出力する<br />　プログラムを作ろう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq4_1_2b();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq4_1_2b_1();"></td>
    			<td><input type="button" value="２" onClick="hintq4_1_2b_2();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="4122"></div>
	<div id="state">-4122</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章　繰り返し　>　第一節　for　>　問題２">
  		<p><br />
    	<b>for文を使って値を4回入力し、<br />4回入力した値の平均値を求め、<br />「平均値は○です」と出力するプログラムを作ろう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
