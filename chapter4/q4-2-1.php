	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq4_2_1_1()"></td>
    			<td><input type="button" value="２" onClick="hintq4_2_1_2()"></td>
    			<td><input type="button" value="３" onClick="hintq4_2_1_3()"></td>
    		</tr>
    	</table>
	</div>
