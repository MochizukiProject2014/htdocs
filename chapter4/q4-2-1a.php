...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br>　100より大きい値を入力するまで<br />　終わらないプログラムを作ろう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq4_2_1a();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<div class = "com" id = "com"><p><b>問題に挑戦にゃ！足りないプログラムを書き足して、</br>問題に沿ったプログラムを完成させるにゃ。<br />この問題はヒントがないにゃ！！わからなくなったら辞書を見てみるにゃ。</b></p></div>
	...
	<div id="ver" version="4211"></div>
	<div id="state">-4211</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章　繰り返し　>　第二節　while　>　問題２">
  		<p><br />
    	<b>100より大きい値を入力するまで終わらないプログラムを作ろう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
