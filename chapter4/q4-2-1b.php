...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br />　0以外の値が入力されたら変数xにその値を<br>　足していき、0が入力されたら現在のxの<br>　値を出力し終了するプログラムを作ろう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq4_2_1b();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq4_2_1b_1();"></td>
    			<td><input type="button" value="２" onClick="hintq4_2_1b_2();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="4212"></div>
	<div id="state">-4212</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章　繰り返し　>　第二節　while　>　問題２">
  		<p><br />
    	<b>0以外の値が入力されたら変数xにその値を足していき、<br />0が入力されたら現在のxの値を出力し<br />終了するプログラムを作ろう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
