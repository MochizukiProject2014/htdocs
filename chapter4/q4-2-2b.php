...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br>　while文を使って九九の2の段の表を作ろう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq4_2_2b();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq4_2_2b_1();"></td>
    			<td><input type="button" value="２" onClick="hintq4_2_2b_2();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="4222"></div>
	<div id="state">-4222</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章　繰り返し　>　第二節　while　>　問題２">
  		<p><br />
    	<b>while文を使って九九の2の段の表を作ろう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
