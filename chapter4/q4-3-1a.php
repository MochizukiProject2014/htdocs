...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br />　for文を二重に用いて0～9 までの数字を、<br />　0から順番に1行目に「0」、2行目には<br>　「01」、3行目には「012」…の<br />　ように 10行分出力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq4_3_1a();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq4_3_1a_1();"></td>
    			<td><input type="button" value="２" onClick="hintq4_3_1a_2();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="4311"></div>
	<div id="state">-4311</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章　繰り返し　>　第二節　while　>　問題２">
  		<p><br />
    	<b>for文を二重に用いて0～9 までの数字を、<br />0から順番に1行目に「0」、2行目には「01」、3行目には「012」…の<br />ように 10行分出力しよう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
