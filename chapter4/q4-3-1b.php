...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br>　左上から右下に「*」で対角線を引いた、<br />　5×5の「・」で描いた四角形を<br>　出力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq4_3_1b();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq43121();"></td>
    			<td><input type="button" value="２" onClick="hintq4_3_1b_2();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="4312"></div>
	<div id="state">-4312</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第四章　繰り返し　>　第三節　二重ループ　>　問題１">
  		<p><br />
    	<b>左上から右下に「*」で対角線を引いた、5×5の「・」で描いた四角形を出力しよう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
