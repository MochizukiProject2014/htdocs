...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question">問題<font size = "2"><br />大きさが10の配列aを宣言し、「変数bに値を入力し、<br>変数bを使って配列aの要素を指定して出力」を2回繰り返そう。<br />（挑戦状にあったように、変数bに入力する値は<br>　「1,9」の順に入力しよう。）</font></p>
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintqc5_matome_1()"></td>
    			<td><input type="button" value="２" onClick="hintqc5_matome_2()"></td>
    			<td><input type="button" value="３" onClick="hintqc5_matome_3()"></td>
    		</tr>
    	</table>
	</div>
