...
<script type="text/javascript" src="../js/moveex/moveex512.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		...
		<b>お手本</b></font><br><br />　配列に順番に要素をscanfで入力し、<br>　その後出力しよう。</p>
...
<div id="ver" version="e512" type="ex"></div>
<div id="state">40</div>
<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章 配列　>　第一節 配列　>　お手本２">
  		<p><br />
    	<b>配列に順番に要素をscanfで入力し、その後出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイアログここまで   -->
