...
<script type="text/javascript" src="../js/moveex/moveex521.js"></script>
...
<a href="../img/screen_img/reidai-8.jpg" data-lightbox="group1" title="説明8"></a>
	...
	<div class = "code-box">
		...
		<b>お手本</b></font><br /><br />　二次元配列の要素をすべて順番に出力しよう。</p>
...
<div id="ver" version="e521" type="ex"></div>
<div id="state">43</div>
<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章 配列　>　第二節 二次元配列　>　お手本１">
  		<p><br />
    	<b>二次元配列の要素をすべて順番に出力しよう。<br />
		</b><br />
 		</p>
	</div>
	<!---  ダイアログここまで   -->
