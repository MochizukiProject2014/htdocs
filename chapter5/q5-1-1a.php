...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br>　「大きさが「3」でint型の配列aを<br />｛3,6,9｝で初期化しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq5_1_1a();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq5_1_1a();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="5111"></div>
	<div id="state">-5111</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章　配列　>　第一節　配列　>　問題１">
  		<p><br />
    	<b>大きさが「3」でint型の配列aを｛3,6,9｝で初期化しよう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
