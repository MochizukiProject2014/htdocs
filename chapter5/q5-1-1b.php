...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br>　「宣言されている配列の一番最初の要素を<br>　呼び出し、出力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq5_1_1b();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq5_1_1b();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="5112"></div>
	<div id="state">-5112</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章　配列　>　第一節　配列　>　問題１">
  		<p><br />
    	<b>宣言されている配列の一番最初の要素を呼び出し、出力しよう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
