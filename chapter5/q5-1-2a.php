...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br />　for文を使って、宣言されている配列の<br />　要素を最初から順に出力する<br />　プログラムを作ろう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq5_1_2a();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq5_1_2a();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="5121"></div>
	<div id="state">-5121</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章　配列　>　第一節　配列　>　問題２">
  		<p><br />
    	<b>for文を使って、宣言されている配列の要素を最初から順に<br />出力するプログラムを作ろう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
