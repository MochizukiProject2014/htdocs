...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br />　大きさが「3」でint型の配列xを宣言し、<br />　for文を使って要素にキーボードから<br />　任意の値を入力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq5_1_2b();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq5_1_2b_1();"></td>
    			<td><input type="button" value="２" onClick="hintq5_1_2b_2();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="5122"></div>
	<div id="state">-5122</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章　配列　>　第一節　配列　>　問題２">
  		<p><br />
    	<b>大きさが「3」でint型の配列xを宣言し、<br />for文を使って要素にキーボードから任意の値を入力しよう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
