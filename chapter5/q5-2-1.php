...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box">
		<p class = "question"><font size = "4">問題<br /><br>　大きさが[2][3]の、int型の二次元配列を<br>　好きな値で初期化しよう。</font></p>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<div class = "com" id = "com"><p><b>問題に挑戦にゃ！足りないプログラムを書き足して、</br>問題に沿ったプログラムを完成させるにゃ。<br />わからなかったらポイントボタンを押すにゃ！<br />辞書も活用するにゃ。<br />「サンプル実行」をクリックすると、サンプルアニメーション</br>を見ることができるにゃ。それを手掛かりにクリアを目指すにゃ。</b></p></div>
		<table class = "hinttable">
  			<tr>
    			<td><font size = "5">ポイント</font></td>
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq5211()"></td>
    			<td><input type="button" value="２" onClick="hintq5212()"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="dialog-message" title="第五章　配列　>　第二節　二次元配列　>　問題２">
  		<p><br />
    	<b>大きさが[2][3]の、int型の二次元配列を好きな値で初期化しよう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
