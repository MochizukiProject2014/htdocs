...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box"><p class = "question"><font size = "4">問題<br /><br>　大きさが[2][3]でint型の二次元配列xを<br>　任意の値で初期化しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq5_2_1a();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq5_2_1a();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="5211"></div>
	<div id="state">-5211</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章　配列　>　第二節　二次元配列　>　問題１">
  		<p><br />
    	<b>大きさが[2][3]でint型の二次元配列xを任意の値で初期化しよう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
