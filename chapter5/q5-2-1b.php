...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box"><p class = "question"><font size = "4">問題<br>　大きさが[2][2]でint型の二次元配列xを<br />　宣言し、二重ループを使って要素に<br />　キーボードから任意の値を入力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq5_2_1b();"></br>
...
int main(void){
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq5_2_1b();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="5212"></div>
	<div id="state">-5212</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章　配列　>　第二節　二次元配列　>　問題１">
  		<p><br />
    	<b>大きさが[2][2]でint型の二次元配列xを宣言し、<br />二重ループを使って要素にキーボードから任意の値を入力しよう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
