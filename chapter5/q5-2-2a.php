...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box"><p class = "question"><font size = "4">問題<br /><br>　宣言されている配列を、二重ループを<br>　使って先頭から順に出力しよう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq5_2_2a();"></br>
...
int main(void){
   ...
   return 0;
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq5_2_2a();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="5221"></div>
	<div id="state">-5221</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章　配列　>　第二節　二次元配列　>　問題２">
  		<p><br />
    	<b>宣言されている配列を、二重ループを使って先頭から順に出力しよう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
