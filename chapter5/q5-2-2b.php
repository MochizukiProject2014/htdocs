 ...
 <body id = "c2">
	...
	<div class = "menu-box">
    	...
    	<a href="../login/top.php">MENU</a> <span id="divider">></span>
   	    <a href="../chapter5/chapter5.php">第五章 配列</a> <span id="divider">></span> 
    	 第二節 二次元配列 問題２&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <?php
...
?>
    	        ...
    	        <a href="../img/screen_img/mondai-01.jpg" data-lightbox="group2" style = "float:right;padding:0px 15px;" id = "click_data"><img src='../img/new_button/b005.png' alt="画面説明" onMouseOver=this.src='../img/new_button/b005-2.png' onMouseOut=this.src='../img/new_button/b005.png'></a>
...
<a href="../img/screen_img/mondai-016.jpg" data-lightbox="group2" title="説明16"></a>
	...
	<div class = "code-box"><p class = "question"><font size = "4">問題<br>　宣言されている配列から任意の要素を<br />　3つ呼び出し、平均値を計算して出力する<br />　プログラムを作ろう。</font></p>
		<input class = "resetbut" type="button" value="リセット" onclick="resetq5_2_2b();"></br>
   ...
   return 0;
	...
	<div class = "anime-box">
		...
		<ul class = "content">
			...
			<li class = "hide"><div class = "dic"><object data="../dic/dic8.html" type="text/html" width="730" height="460"></object></div></li>
	...
	<div class = "hint-box">
		...
		<table class = "hinttable">
  			<tr>
    			...
    			<td>&nbsp;&nbsp;&nbsp;</td>
    			<td><input type="button" value="１" onClick="hintq5_2_2b_1();"></td>
    			<td><input type="button" value="２" onClick="hintq5_2_2b_2();"></td>
    		</tr>
    	</table>
	</div>
	...
	<div id="ver" version="5222"></div>
	<div id="state">-5222</div>
	
	<!--　ダイアログ　-->
	<div id="dialog-message" title="第五章　配列　>　第二節　二次元配列　>　問題２">
  		<p><br />
    	<b>宣言されている配列から任意の要素を3つ呼び出し、<br />平均値を計算して出力するプログラムを作ろう。
		</b><br />
 		</p>
	</div>
	<!---  ダイヤログここまで   -->
