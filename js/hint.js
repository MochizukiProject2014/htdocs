...
function hintq2_1_1_1(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  1/2<br><br />「int型の変数xを宣言」というのは<br/><font color = red>データ型がint</font>で、<font color = red>変数名をx</font>にして宣言することにゃ。<br/>書き方が分からなかったら辞書の「変数宣言」の項を見るにゃ。</p>";
}
...
function hintq2_2_1_1(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  1/2<br><br />問題文の「<font color = red>入力</font>」とはscanfを使って代入することだにゃ。</b></p>";
}
...
function hintc2_matome1(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  1/2<br><br>怪盗Cからの挑戦状だにゃ!<br /><font color = red>scanfとprintf</font>を使うにゃ。</b></p>";
}
function hintc2_matome2(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  2/2<br><br>scanfで値を入力→値を３倍にして代入→printfで出力の順番にゃ。<br />わからなくなった時は<font color = red>辞書</font>で確認するにゃ。</b></p>";
}
...
function hintc3_matome2(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  2/3<br><br />bmiの値である　体重[kg] / (身長[m]×身長[m])　が<br><font color = red>18.5以上25.0未満は適正、<br>適正より上は太り気味、適正未満はやせ気味</font>だにゃ。</b></p>";
}
function hintc3_matome3(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  3/3<br><br />「<font color = red>適正体重なら</font>」適正で、「<font color = red>適正体重以外で25.0以上なら</font>」<br>　太り気味で、「<font color = red>それ以外なら</font>」やせ気味だにゃ。<br/>「if」と、「else if」と、「else」を使うにゃ！</b></p>";
}
...
function hintc4_matome2_3(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  3/3<br><br />二重ループを作るにゃ！<br />外側のループでは何行目かを制御して、</br>内側のループでは「*」を出力する個数を制御するにゃ。</b></p>";
	//document.getElementById("com").innerHTML = "<p><b>ヒント  3/3<br><br />次は二重ループを作るにゃ！</br>外側のループには何行目かを制御するループを作り、</br>その中に＊を出力するループを作るにゃ。</b></p>";
}
...
function hintq4_3_1a_1(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  1/2<br><br />外側のループが一回目のときは内側は一回ループ、二回目のときは内側二回ループ…のような二重ループを作るにゃ</b></p>";
}
function hintq4_3_1a_2(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  2/2<br /><br />出力は内側のループでループの回数をカウントしている変数を出力するにゃ</b></p>";
}
...
function hintq5_2_2_1(){
	document.getElementById("com").innerHTML = "<p><b>ヒント  1/1<br>二次元配列を扱うときは<br>「配列名[数字][数字]」で呼び出せるにゃ。<br/>例えば今回二次元配列dataの値「6」を呼び出したかったら<br>data[1][2]のように書けばいいにゃ。</b></p>";
}
