...
tm.define("MainScene", {
    ...
    init: function() {
        ...
        //点滅する三角形
        nextTriangle = tm.display.Shape(50,50);
        ...
        //話者
        speaker = tm.display.Label(frames[0].speaker);
		...
		//メッセージ
        message = tm.display.Label(frames[0].message.charAt(0));
        ...
        //*でできた三角形の絵
        //picture = tm.app.Shape(300,300);
        picture.canvas.clearColor("white");
        picture.canvas.lineWidth=10;
        picture.canvas.strokeRect(0,0,300,300);
        picture.setPosition(600,400);

        picLabel = tm.display.Label("＊\n＊＊\n＊＊＊\n＊＊＊＊\n＊＊＊＊＊");
        picLabel.setFontSize(45);
        picLabel.setFillStyle("black");
        picLabel.setAlign("left").setBaseline("top");
        picLabel.setPosition(-115,-130);
        picLabel.addChildTo(picture)

        picture.addChildTo(this);
        picture.hide();
